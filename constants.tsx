...
import { User, UserRole, Stakeholder } from './types';

export const STAKEHOLDERS: Stakeholder[] = [
  { id: '1', name: 'Client', role: 'Client', color: '#18181b' },
  { id: '2', name: 'Contractor', role: 'Contractor', color: '#52525b' },
  { id: '3', name: 'Vendor', role: 'Vendor', color: '#71717a' },
  { id: '4', name: 'Consultant', role: 'Consultant', color: '#27272a' },
];
...
export const SIMULATED_USERS: User[] = [
  { 
    ...
    settings: {
      ...
      enableMentionShortcuts: true,
      enableDateShortcuts: true,
      autoCleanShortcuts: true,
      branding: {
        logoSize: 100,
        logoInverted: false
      }
...
export const COLORS = {
  P1: 'text-[#dc2626] bg-[#fef2f2] border-[#fecaca]',
  P2: 'text-[#18181b] bg-[#f4f4f5] border-[#e4e4e7]',
  P3: 'text-[#71717a] bg-[#fafafa] border-[#f4f4f5]',
};
...
export const Icons = {
  ...
  Unarchive: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m15 5 5 5-5 5"/><path d="M4 11V9a2 2 0 0 1 2-2h14"/><path d="M2 15h20v6H2z"/></svg>
  ),
  Timeline: () => (
  ...
  Upcoming: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/><path d="M7 14h.01"/><path d="M12 14h.01"/><path d="M17 14h.01"/><path d="M7 18h.01"/><path d="M12 18h.01"/><path d="M17 18h.01"/></svg>
  ),
  Link: () => (
